...
def main():
    ...
    df_result = df.select(
        ...
        udf_get_subentry(lit('SQ63'),
                         ...
                         coalesce(df_cap['nationality'], df_ctp['national'], df_ctp['country'])).alias('nationality'),
        # 国籍
        ...
        udf_get_subentry(lit('SQ63'),
                         ...
                         coalesce(df_cap['assetmgrclienttype'], df_ctp['assetmgrclienttype'], lit('1'))).alias(
            'assetmanagetype'),  # 资管类型
